...
(function () {
  ...
  function resetGame() {
    dino = { x: 60, y: GROUND, w: 44, h: 58, vy: 0, onGround: true };
    obstacles = [];
    score = 0;
    speed = 5.5;
    frameCount = 0;
  ...
  function drawDino(ctx, x, y, onGround, frame) {
    ...
    if (!onGround) {
      ...
      ctx.fillRect(x+24*p, y+0*p, p, p); ctx.fillRect(x+28*p, y+3*p, p, p); ctx.fillRect(x+29*p, y+7*p, p, p); ctx.fillRect(x+29*p, y+8*p, p, p); ctx.fillRect(x+28*p, y+9*p, p, p); ctx.fillRect(x+22*p, y+16*p, p, p); ctx.fillRect(x+20*p, y+21*p, p, p);
    } else if (runFrame) {
      ...
      ctx.fillStyle = '#4a5568';
      ctx.fillRect(x+17*p, y+0*p, p, p); ctx.fillRect(x+20*p, y+0*p, p, p); ctx.fillRect(x+21*p, y+0*p, p, p); ctx.fillRect(x+22*p, y+0*p, p, p); ctx.fillRect(x+22*p, y+1*p, p, p); ctx.fillRect(x+23*p, y+1*p, p, p); ctx.fillRect(x+24*p, y+1*p, p, p); ctx.fillRect(x+25*p, y+2*p, p, p); ctx.fillRect(x+26*p, y+3*p, p, p); ctx.fillRect(x+26*p, y+4*p, p, p); ctx.fillRect(x+0*p, y+6*p, p, p); ctx.fillRect(x+0*p, y+9*p, p, p); ctx.fillRect(x+0*p, y+10*p, p, p); ctx.fillRect(x+18*p, y+10*p, p, p); ctx.fillRect(x+20*p, y+10*p, p, p); ctx.fillRect(x+18*p, y+11*p, p, p); ctx.fillRect(x+18*p, y+12*p, p, p); ctx.fillRect(x+20*p, y+12*p, p, p); ctx.fillRect(x+18*p, y+13*p, p, p); ctx.fillRect(x+20*p, y+13*p, p, p); ctx.fillRect(x+16*p, y+14*p, p, p); ctx.fillRect(x+20*p, y+14*p, p, p); ctx.fillRect(x+4*p, y+15*p, p, p); ctx.fillRect(x+6*p, y+16*p, p, p); ctx.fillRect(x+18*p, y+17*p, p, p);
      ctx.fillStyle = '#f1f6f9';
